...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="mobile-topbar md:hidden fixed top-0 left-0 right-0 z-40 bg-gray-900 text-white border-b border-gray-800 flex items-center gap-3 px-4 py-3">
        <button
        ...
        <h1 className="text-lg font-semibold">CRM для СТО</h1>
      </div>
      ...
      <div
        className={`sidebar flex flex-col w-64 h-screen bg-gray-900 text-white shadow-2xl border-r border-gray-800 ${isOpen ? "open" : ""}`}
      >
        {/* Заголовок */}
